package com.noumenon.similarity.hownet2000.sememe;
...
public class LiuqunSememeParser extends SememeParser {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(myLiuqunSememeParser.getPath("鱼"));
        System.out.println(myLiuqunSememeParser.getPath("水果"));
        myLiuqunSememeParser.setParameter(1.6);
        System.out.println(myLiuqunSememeParser.getSimilarity("鱼", "水果"));
    }
}
