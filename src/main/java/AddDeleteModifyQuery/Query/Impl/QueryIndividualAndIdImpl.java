...
public class QueryIndividualAndIdImpl implements QueryIndividualAndId {
	public static String SERVER = "http://127.0.0.1:3030/EnglishLearningDataset/query";

	public QueryIndividualAndIdImpl() {

	}

	public ResultSet checkInstanceAndId(String yourClass) {

		String string1 = "SELECT ?instanceLabel ?propertyID WHERE{?class <http://www.w3.org/2000/01/rdf-schema#label> \"";
		String string2 = "\"@zh."
