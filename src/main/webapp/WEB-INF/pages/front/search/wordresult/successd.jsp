	...
	<div align="center" class="header" style="margin-top:8cm;">
		<form action="search/addResource.html" method=post>
         <p style="font-family:verdana;font-size:50px;color:F0CBD0"> 
            <img src="image/xiao.png" width="150" height="150">    
                                      恭喜你！添加成功                
         </p> 
         <p>
             <!-- <input name="text" type="button" value="继续添加" style="margin-left:240px; margin-top:100px; width:100px; height:50px;" onclick="window.location.href='search/input.html'" />  -->
		     <input name="Search" type="button" value="继续添加" style="margin-left:100px;margin-top:100px; height:50px;" onclick="window.location.href='search/addResourceMessage.html'" /> 
         </p>                                      
		</form>
		<br/> <br/>
		<br />
